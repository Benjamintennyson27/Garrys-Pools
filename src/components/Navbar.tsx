...
export default function Navbar() {
  ...
  return (
    <header className="fixed top-6 left-0 right-0 z-50 flex justify-center px-4">
      ...
      >
        <a href="#" className="flex items-center -ml-2" aria-label="Garry's Pools and Services — Home">
          <img
            src="/logo.png"
            alt="Garry's Pools and Services Logo"
            className={`h-16 md:h-20 w-auto object-contain transition-all duration-300 transform origin-left hover:scale-105 ${!scrolled ? 'brightness-0 invert' : ''}`}
          />
        </a>
        ...
        <div className="flex items-center gap-4">
          <a href="tel:0418228322" className="hidden md:flex items-center gap-2 text-sm font-bold hover:text-aqua transition-colors" aria-label="Call us directly at 0418 228 322">
