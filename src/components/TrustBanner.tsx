...
export default function TrustBanner() {
    const trustSignals = [
        { icon: ShieldCheck, text: 'Industry Leading Brands' },
        { icon: BadgeCheck, text: 'Expert Maintenance Team' },
        { icon: ThumbsUp, text: 'Reliable Sydney Wide Service' },
        { icon: CheckCircle2, text: '40+ Years of Excellence' },
    ];
