...
export default function ServiceAreas() {
    const areas = [
        'Maroubra', 'Coogee', 'Randwick', 'Bondi', 'Kingsford', 'Kensington',
        'Clovelly', 'Bronte', 'Malabar', 'Matraville', 'Eastern Suburbs', 'Sydney CBD'
    ];
        ...
        <section aria-label="Areas We Serve" className="py-24 bg-cream border-t border-navy/5">
            <div className="max-w-5xl mx-auto px-6 md:px-16 text-center">
                ...
                <p className="text-lg text-charcoal/70 max-w-2xl mx-auto mb-12">
                    We bring pool care to you anywhere in Sydney. From the Eastern Suburbs to the CBD and everywhere in between, we've got Sydney covered.
                </p>
