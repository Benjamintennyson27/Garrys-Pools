    ...
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto flex flex-col gap-12 md:gap-20">
        <div ref={text1Ref} className="text-xl md:text-3xl font-sans font-medium text-cream/60 max-w-2xl">
          We believe that achieving the perfect swim is both an art and a science.
        </div>

        <div ref={text2Ref} className="text-4xl md:text-6xl lg:text-7xl font-serif italic text-white leading-tight">
          As a proudly Sydney-based business, we bring <span className="text-aqua not-italic font-sans font-bold">excellence to your pool.</span>
        </div>
      </div>
    </section>
  );
