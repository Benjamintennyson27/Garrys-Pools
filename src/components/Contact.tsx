            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center max-w-2xl mx-auto mb-16 md:mb-24">
                    ...
                    <h2 className="contact-anim text-3xl md:text-5xl font-bold text-navy mb-6 tracking-tight">
                        Contact Garry's Pools and Services
                    </h2>
                    <p className="contact-anim text-lg text-charcoal/70">
                        Over four decades of experience providing complete pool solutions across Sydney and surrounding areas.
                    </p>
                </div>

                {/* Contact Cards */}
                <div className="contact-anim grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                    <a href="tel:0418228322" className="group bg-cream hover:bg-navy rounded-2xl p-6 flex flex-col items-center text-center gap-3 transition-all duration-300 border border-navy/5 hover:border-aqua/30">
                        ...
                        <p className="text-sm text-charcoal/60 group-hover:text-cream/70 transition-colors">0418 228 322</p>
                        <span className="text-xs font-mono text-aqua tracking-widest uppercase mt-1">Call Now →</span>
                    </a>

                    <a href="mailto:garryspools@gmail.com" className="group bg-cream hover:bg-navy rounded-2xl p-6 flex flex-col items-center text-center gap-3 transition-all duration-300 border border-navy/5 hover:border-aqua/30">
                        <div className="w-12 h-12 rounded-full bg-aqua/10 group-hover:bg-aqua/20 flex items-center justify-center transition-colors">
                            <Mail size={20} className="text-aqua" />
                        </div>
                        <h3 className="font-bold text-navy group-hover:text-white transition-colors">Email</h3>
                        <p className="text-sm text-charcoal/60 group-hover:text-cream/70 transition-colors">garryspools@gmail.com</p>
                        <span className="text-xs font-mono text-aqua tracking-widest uppercase mt-1">Send Email →</span>
                    </a>

                    <a href="https://www.google.com/maps/search/?api=1&query=Maroubra,+NSW,+Australia" target="_blank" rel="noopener noreferrer" className="group bg-cream hover:bg-navy rounded-2xl p-6 flex flex-col items-center text-center gap-3 transition-all duration-300 border border-navy/5 hover:border-aqua/30">
                        <div className="w-12 h-12 rounded-full bg-aqua/10 group-hover:bg-aqua/20 flex items-center justify-center transition-colors">
                            <MapPin size={20} className="text-aqua" />
                        </div>
                        <h3 className="font-bold text-navy group-hover:text-white transition-colors">Location</h3>
                        <p className="text-sm text-charcoal/60 group-hover:text-cream/70 transition-colors">Maroubra, NSW</p>
                ...
                <div className="contact-anim mb-20 rounded-2xl overflow-hidden border border-navy/5 h-[400px] shadow-sm">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d105822.84655519808!2d151.2421!3d-33.9407!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6b12b32258aa5655%3A0x5017d681632ad40!2sMaroubra%20NSW%2C%20Australia!5e0!3m2!1sen!2sus!4v1709400000000!5m2!1sen!2sus"
                        width="100%"
                        height="100%"
                        style={{ border: 0 }}
                        ...
                        title="Garry's Pools and Services Location"
                    ></iframe>
                </div>
                ...
                <div className="contact-anim mt-16 bg-navy rounded-3xl p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8" id="quote">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                        <a href="tel:0418228322" className="btn-magnetic bg-aqua text-navy px-8 py-4 text-base font-bold whitespace-nowrap">
                            📞 0418 228 322
                        </a>
                        <a href="mailto:garryspools@gmail.com" className="btn-magnetic bg-white/10 text-white border border-white/20 px-8 py-4 text-base whitespace-nowrap">
                            ✉️ Email Us
                        </a>
                    </div>
                </div>
