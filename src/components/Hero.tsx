...
export default function Hero() {
  ...
  return (
    <section
      ref={container}
      aria-label="Hero — Garry's Pools and Services"
    ...
    >
      ...
      <div className="relative z-20 max-w-4xl text-white">
        ...
        <p className="hero-anim mt-8 max-w-xl text-lg md:text-xl text-cream/80 font-medium">
          Top-notch pool and spa cleaning and maintenance all over Sydney. Trust us to keep your outdoor oasis sparkling year-round.
        </p>
